...
public class FileUriUtils {
    ...
    public static final String EXTERNALSTORAGEDOC = "com.android.externalstorage.documents";
    public static final String ISDOWNLOADDOC = "com.android.providers.downloads.documents";
    public static final String ISMEDIADOC = "com.android.providers.media.documents";
    public static final String ISGOOGLEPHOTODOC = "com.google.android.apps.photos.content";
    ...
    public static String getURIForMediaDoc(ContentResolver mContentResolver, Uri uri) {
    ...
    public static String getURIForDownloadDoc(ContentResolver mContentResolver, Uri uri) {
        String documentId = DocumentsContract.getDocumentId(uri);
        // Build download uri.
    ...
    public static String getURIForExternalstorageDoc(Uri uri) {
        String documentId = DocumentsContract.getDocumentId(uri);
        String[] idArr = documentId.split(":");
        if (idArr.length == 2) {
            String type = idArr[0];
